...
def main() -> None:
    ...
    if n_groups < 2:
        ...
        _oof_log, m_log = cross_val_grouped(X, y, groups, clone(log_full), n_splits=n_splits)
        print("  metrics:", m_log)
        ...
        _oof_base, m_base = cross_val_grouped(X_base, y, groups, clone(log_base), n_splits=n_splits)
    ...
    print("In-sample logistic:", evaluate_probs(y, p_final))
    ...
    export_app_json(feats, p_final, matches, team_ids, Path(args.out_json))
    print("Done.")
